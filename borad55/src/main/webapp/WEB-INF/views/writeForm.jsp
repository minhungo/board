...
<div class="d-flex" style="border: 0px; position:absolute; top:230px; left:120px; width:220px;">  
      <div class="container row"
         style="background-color: white; padding: 0px; margin-left:35px;">
               ...
               <c:if test="${empty profile.signup_id}">
                  <c:forEach var="connectUser" items="${connectUser}">
                     &nbsp;&nbsp;<div class="border-bottom " style="width: 230px; padding: 0px;" id="${connectUser.signup_nickname}" onclick="settingMenuToggle2(); test1('${connectUser.signup_nickname}','${profile.signup_id }');">
                        ...
                        <span style="padding-left: 50px">${connectUser.signup_nickname}</span>
                        <c:choose>
...
<button type="button" class="btn btn-success" style="width: 150px; display: inline-block; margin-bottom: 10px; margin-left:60px;" ><a href="/chat" style="color:white;" onclick="window.open(this.href,'유저정보','width=303,height=467,top=100,left=500');return false;">전체채팅방</a></button><br>
      ...
      <form action="writeAction" method="post" style="height:1000px; width:770px;">


					<input type="hidden" name="board_idx" value="${dto.board_idx }"> 
					<input type="hidden" name="board_name" value="${profile.signup_nickname}"> 
					<input type="hidden" name="page" value="${page}"> 
					<input type="hidden" name="searchType" value="${scri.searchType}"> 
					<input type="hidden" name="keyword" value="${scri.keyword}">
					<input type="hidden" name="board_profle_img" value="${profile.signup_profle_img}">
					<input type="hidden" name="board_writer_id" value="${profile.signup_id}">


					<div class="row mb-5" style="width:750; height:40px; margin-left:1px;">
                     <label class="mb-2" for="name" style="color: #0D6EFD; padding-left:0px;"><strong>카테고리</strong></label>
                     <select name="bgno" id="bgno" class="mb-5" style="width:770px; height:30px; padding-left:10px; margin-left:10px:">
                  ...
                  <div class="mb-3">
                     <div class="mt-3">
                        <label class="mb-2"  style="color: #0D6EFD;"><strong>작성자</strong></label>
                        <b> : ${profile.signup_nickname}</b>
                     </div>
                  </div>
               ...
               <div class="mb-3">
                  <label class="mb-2" for="title" style="color: #0D6EFD;"><strong>제목</strong></label>
               ...
               <div class="mb-3">
                  ...
                  <textarea class="form-control" rows="2" cols="50" name="board_content" style="width: 615px; height: 200px;"
                     placeholder="명예훼손, 개인정보 유출, 분쟁유발, 허위사실 유포 등은 이용약관에 의해 제재는 물론 볍률에 의해 처벌 받을 수 있습니다. 건전한 거뮤니티를 위해 자제 당부 드립니다.">
                  </textarea>
               ...
               <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  <button type="submit" class="btn btn-outline-primary me-md-2">글 작성</button>
               </div>
           </form>
