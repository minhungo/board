        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" >
                    ...
                    <h3 style="margin:30px 30px;">신고 유저 내역</h3>
           ...
           <table style=" width:1600px;   margin: 30px 10px; text-align:center; ">
               ...
               <tr>
                  ...
                  <td>${signupDTO.user_reportcheck }</td>
                  
                  <td><a href='/sanctions?signup_num=${signupDTO.signup_num}' onclick="window.open(this.href,'제재','width=470,height=330,top=300,left=500');return false;">
                  <button type="button" class="btn btn-outline-danger">제재하기</button></a></td>
               </tr>
               </c:forEach>
             </table>
               ...
               <ul class="pagination justify-content-center">
                  ...
                  <c:if test="${pageMaker.prev}">
                     <li class="page-item"><a class="page-link"
                        href="userReportlist${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
                  </c:if>
                  <c:forEach begin="${pageMaker.startPage}"
                     end="${pageMaker.endPage}" var="idx">
                     <li class="page-item"><a class="page-link"
                        href="userReportlist${pageMaker.makeSearch(idx)}">${idx}</a></li>
                  </c:forEach>
                  <c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
                     <li class="page-item"><a class="page-link"
                        href="userReportlist${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
                  </c:if>
               </ul>
            </nav>
