...
<body>
	...
	<div class="wrap">
		<div class="login">
			<h2 class="log_in_logo"><b>아이디 찾기</b></h2>


			<div class="login_id">
				<h4><b>본인확인 이메일 인증</b></h4>
                <hr>
                <font>가입 당시의 <b>이름,이메일 주소</b>와 입력한 정보가 같아야, 인증번호를 받을 수 있습니다.</font>
               ...
               <div id="code" style="display: none;">
                <br>  
                    ...
                    <button class="btn btn-primary btn-lg btn-block"  type="button"  id="next" >다음</button>
                </div>
